        ...
        foreach ($_FILES as $arr){
            ...
            if($valid){
                ...
                if($rows == 0){
                    ...
                    // delay to complete the insert query
                    $result = mysqli_query($dbc, "SELECT post_id FROM posts WHERE post_user_id = '$user_id' AND post_title = '$title';");
                    if($result){
...
<head>
    ...
    <style>
        div.add-archive-container{
            position: absolute;
            left: 400px
        }
        div.add-archive-padding{
            padding-top: 100px;
        }
    </style>
</head>
...
<div class="add-archive-container">
    <div class="add-archive-padding"></div>
    <div class="profile">
        <a href="../login/profile.php">
            <img src="<?php echo '../img/profileresize/'.$_SESSION['profile_picture']?>" width="40px" height="40px" alt="">
        </a>
        <span><?php echo $_SESSION['firstname'].' '.$_SESSION['lastname']?></span>
    </div>
    <div class="form-container">
        <div class="form-paddding"></div>
        <div class="form">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="title">
                    <input type="text" name="title" id="title" required class="title">
                </div>
                <div class="add-files">
                    
                    <img src="/../../6zfm6y.jpg" alt="" class="add-files" height="100px" width="100px">
                    <img src="/../../6zfm6y.jpg" alt="" class="add-files" height="100px" width="100px">
                    <img src="/../../6zfm6y.jpg" alt="" class="add-files" height="100px" width="100px">
                    <img src="/../../6zfm6y.jpg" alt="" class="add-files" height="100px" width="100px">
                    <img src="/../../6zfm6y.jpg" alt="" class="add-files" height="100px" width="100px">
                ...
                <br>
                <input type="search">
                <div class="target-list-container" width="200px" height="200px">
                <span><div class="target-item">Hanrickson Dumapit</div></span>
                    <span><div class="target-item">Hanrickson Dumapit</div></span>
                </div>
                <br>
                <input type="submit" value="add" name="addarchive">
            </form>
        </div>
    </div>
</div>
